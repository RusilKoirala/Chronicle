...
export function AuthForm({ onSuccess, standalone = false }: AuthFormProps) {
    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <Button
          type="button"
          variant="outline"
          className={`w-full ${isMobileApp ? 'h-12' : 'h-10'}`}
        ...
        <Tabs defaultValue="signin" className="w-full">
          <TabsList className={`grid w-full grid-cols-2 ${isMobileApp ? 'h-12' : ''}`}>
          ...
          <TabsContent value="signin" className="space-y-4 mt-6">
            <form onSubmit={handleSignIn} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 ${isMobileApp ? 'h-12' : ''}`}
              ...
              <Button 
                type="submit" 
                className={`w-full ${isMobileApp ? 'h-12' : ''}`} 
                disabled={isLoading}
              >
